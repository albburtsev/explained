...
- [x] 2.1 Add the planned `openspec` slug to the existing course frontmatter block without changing its lesson references.
- [x] 2.2 Add the planned `openspec/...` path-shaped slugs to all three existing lesson frontmatter blocks without renaming or moving their files.
